...
Partial Class FHasil
    ...
    Private Sub InitializeComponent()
        ...
        LabelKarir2nd.Location = New Point(3, 86)
        ...
        LabelKarir3Rd.Location = New Point(3, 86)
        ...
        Label4.TabIndex = 3
        Label4.Text = "Top 3 Karir Yang Sesuai"
        ' 
        ' Label6
        ' 
        ...
        Label7.TabIndex = 6
        Label7.Text = "Reality Check"
        ' 
        ' Label8
        ' 
        Label8.Anchor = AnchorStyles.None
        Label8.AutoSize = True
        Label8.Location = New Point(18, 93)
        ...
        ' LabelGoldeMatch
        ' 
        LabelGoldeMatch.Anchor = AnchorStyles.None
        LabelGoldeMatch.AutoSize = True
        LabelGoldeMatch.Location = New Point(7, 113)
        LabelGoldeMatch.Margin = New Padding(3, 5, 3, 0)
        ...
        ' LabelHiddenGem
        ' 
        LabelHiddenGem.Anchor = AnchorStyles.None
        LabelHiddenGem.AutoSize = True
        LabelHiddenGem.Location = New Point(6, 113)
        LabelHiddenGem.Margin = New Padding(3, 5, 3, 0)
        ...
        ' LabelRealityCheck
        ' 
        LabelRealityCheck.Anchor = AnchorStyles.None
        LabelRealityCheck.AutoSize = True
        LabelRealityCheck.Location = New Point(6, 113)
        LabelRealityCheck.Margin = New Padding(3, 5, 3, 0)
        ...
        ' LabelExplorer
        ' 
        LabelExplorer.Anchor = AnchorStyles.None
        LabelExplorer.AutoSize = True
        LabelExplorer.Location = New Point(6, 113)
        LabelExplorer.Margin = New Padding(3, 5, 3, 0)
        ...
        ' ButtonKembaliKeAwal
        ' 
        ButtonKembaliKeAwal.Anchor = AnchorStyles.Bottom
        ButtonKembaliKeAwal.AutoSize = True
        ...
        ButtonPrint.AutoSize = True
        ButtonPrint.Location = New Point(695, 405)
        ...
        PictureBox1.Image = My.Resources.ImageRes.noto__treasure_chest
        ...
        PictureBox2.Image = My.Resources.ImageRes.noto__balance_scale
        ...
        ' PictureBox3
        ' 
        PictureBox3.Image = My.Resources.ImageRes.noto__2nd_place_medal
        ...
        PictureBox4.Image = My.Resources.ImageRes.noto__key
        ...
        ' PictureBox6
        ' 
        PictureBox6.Image = My.Resources.ImageRes.noto__3rd_place_medal
        ...
        PictureBox7.Image = My.Resources.ImageRes.noto__1st_place_medal
        ...
        ' ButtonGantiDataUser
        ' 
        ButtonGantiDataUser.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        ButtonGantiDataUser.AutoSize = True
        ButtonGantiDataUser.Location = New Point(12, 407)
        ButtonGantiDataUser.Name = "ButtonGantiDataUser"
        ButtonGantiDataUser.Size = New Size(103, 28)
        ...
        ' LabelEmail
        ' 
        LabelEmail.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        LabelEmail.AutoSize = True
        LabelEmail.Location = New Point(12, 390)
        ...
        ' LabelUsername
        ' 
        LabelUsername.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        LabelUsername.AutoSize = True
        LabelUsername.Location = New Point(12, 369)
        ...
        ' CheckBoxDonSev
        ' 
        CheckBoxDonSev.Anchor = AnchorStyles.Bottom
        CheckBoxDonSev.AutoSize = True
        CheckBoxDonSev.Location = New Point(467, 413)
        ...
        ' 
        ' PrintPreviewDialogTesDoc
        ' 
        PrintPreviewDialogTesDoc.AutoScrollMargin = New Size(0, 0)
        PrintPreviewDialogTesDoc.AutoScrollMinSize = New Size(0, 0)
        PrintPreviewDialogTesDoc.ClientSize = New Size(400, 300)
        PrintPreviewDialogTesDoc.Enabled = True
        PrintPreviewDialogTesDoc.Icon = CType(resources.GetObject("PrintPreviewDialogTesDoc.Icon"), Icon)
        PrintPreviewDialogTesDoc.Name = "PrintPreviewDialogTesDoc"
        PrintPreviewDialogTesDoc.Visible = False
        ' 
        ' DokumenHasilTes
        ' 
        ' 
